...
export const day4: Day = {
  ...
  goal: "Eloquentでモデルとテーブルがどう対応し、リレーションをどう扱うかを説明でき、N+1問題がなぜ起きて・どう気づき・どう直すかを、発行SQLの本数の違いを添えて面接で語れるようになる。",
  lessons: [
    // =================================================================
...
SELECT * FROM users WHERE id IN (1, 2, 3, 4, 5);`,
      ...
      questions: [
        ...
        },
        {
          id: "day4-lesson3-q3",
          type: "free",
          question: "N+1問題とは何か、なぜ起きるか、どうやって気づくかを、面接官に説明するつもりで述べよ。",
