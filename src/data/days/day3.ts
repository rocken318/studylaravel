...
export const day3: Day = {
  ...
  goal: "リクエストがどのURLからどのコントローラのメソッドに届くかを説明でき、RESTfulなルート設計・薄いコントローラ・ルートモデルバインディングの狙いを、面接で自分の言葉で語れるようになる。",
  lessons: [
    // =================================================================
    // Lesson 1: ルーティングの基本
    // =================================================================
...
// $ php artisan route:list`,
      ...
      questions: [
        ...
        },
        {
          id: "day3-lesson1-q3",
          type: "free",
          question: "RESTfulなリソースルートを使うと、どんな利点があるか。面接官に説明するつもりで述べよ。",
            ...
            code: `public function store(StorePostRequest $request, PostService $service)
{
    ...
    return redirect()->route('posts.show', $post);
        ...
        },
        {
          type: "callout",
          variant: "info",
          text: "上の良い例では、業務ロジックを [[service-layer]] に、入力チェックをフォームリクエストに切り出しています。コントローラは「入力を受け取り、担当に委ね、結果を返す」だけの薄い層になっています。",
        },
